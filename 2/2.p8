    ...
    for side=0,1 do
      ...
      if rnd(100)<robp[pat] then
        local rb={fl=fl,side=side,x=sx+10+flr(rnd(40)),y=floor_ground(fl)-7,
          ...
          spd=base_spd*(0.7+rnd(0.6)),skin=flr(rnd(2))}
        add(room.robots,rb)
      end
    end
  end
...
-- robot box is inset 1px each side (bug fix: the full 8x8 box was 1-2px
-- wider than the robot's actual drawn silhouette, making nearby objects hard
-- to search without triggering a hit)
function hit_check()
  if invt>0 then invt-=1 return end
  for r in all(cur_room.robots) do
    if r.fl==rfl and px<r.x+7 and px+8>r.x+1 and py<r.y+7 and py+8>r.y+1 then
      hp=max(0,hp-1)
      invt=45
...
function draw_hud()
  ...
  print("time",2,112,6)
  print(flr(timer/30),22,112,7)
  local fl="floor "..cfloor.."/"..nf
  print(fl,126-4*#fl,112,6)
...
function draw_room()
  ...
  for r in all(cur_room.robots) do
    local base=r.skin==0 and 19 or 36
...

