...
- [x] Room layout: 3 floors (even thirds, ~37px each), centre lift moving automatically top to bottom (rideable: board when it's aligned with your floor, ride it, disembark when aligned with another; crossing when misaligned now falls into the void for 3 HP and a respawn at the room's entry door, jump normally clears it safely — see Phase 3)
